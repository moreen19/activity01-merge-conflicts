...
**Response**: 1. The fail and pass numbers for each of the variables end
with the same number. 2. The fail and pass numbers for each variable
increase as you move from median ,domestic to international.
...
**Response**:The med\_intgross figures are almost double the
med\_domgross test figures
...
**Response**:The movie with more widespread return on investment and few
outliers passes the bechdel test
